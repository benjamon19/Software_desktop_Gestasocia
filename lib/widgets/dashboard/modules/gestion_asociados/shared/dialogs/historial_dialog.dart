...
class HistorialDialog {
  static void show(
    ...
    final HistorialController historialController = Get.put(HistorialController());
    historialController.cargarHistorialAsociado(asociadoId);
  ...
  static Widget _buildHistorialItem(
    ...
    final color = HistorialCambio.getColorTipoAccion(cambio.tipoAccion);
    final icon = HistorialCambio.getIconoTipoAccion(cambio.tipoAccion);
                          ...
                          ...cambio.valoresNuevos!.entries.map((entry) {
                            ...
                            return Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    HistorialCambio.getNombreCampo(campo),
                                    style: TextStyle(
                                      color: AppTheme.getTextPrimary(context),
                                      fontSize: 12,
                                      fontWeight: FontWeight.w600,
