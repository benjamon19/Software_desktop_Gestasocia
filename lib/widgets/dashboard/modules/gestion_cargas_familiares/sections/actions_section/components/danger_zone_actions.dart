...
import '../../../shared/dialogs/delete_carga_confirmation_dialog.dart';
...
class DangerZoneActions extends StatelessWidget {
  ...
  void _showDeleteConfirmation(BuildContext context) {
    ...
    DeleteCargaConfirmationDialog.show(
      context,
      carga: carga,
      onConfirm: onDelete,
    );
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Esta acción no se puede deshacer. Se eliminarán todos los datos de la carga familiar.',
                style: TextStyle(
                  fontSize: 12,
